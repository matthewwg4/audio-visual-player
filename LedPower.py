...
class LEDLights:
    ...
    def update(self):
        ...
        color = colorsys.hsv_to_rgb(self.curr_color+midpoint/3,1,0.8)
        self.colors = [(r*0.85, g*0.85, b*0.85) for (r,g,b) in self.colors]
        self.colors = [(self.colors[i] if i > proportion else color) for i in range(25)]
